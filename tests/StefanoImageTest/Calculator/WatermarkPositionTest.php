 ...
 * @coversNothing
 */
class WatermarkPositionTest extends TestCase
{
     ...
     * @param mixed $maxWatermarkWidthPercent
     * @param mixed $maxWatermarkHeightPercent
     * @param mixed $inputWatermarkWidth
     * @param mixed $inputWatermarkHeight
    ...
    public function test(
        $canvasWidth,
        $canvasHeight,
        $maxWatermarkWidthPercent,
        $maxWatermarkHeightPercent,
        $inputWatermarkWidth,
        ...
        $calculator = new WatermarkPositionCalculator(
            $canvasWidth,
            $canvasHeight,
            $maxWatermarkWidthPercent,
            $maxWatermarkHeightPercent,
